...
function FeatureCard({ feature }: { feature: Feature }) {
  return (
    <div className="group rounded-xl border border-ink-700 bg-ink-900 p-5 transition-all duration-200 hover:border-brand-500/40 hover:bg-ink-850">
      ...
      <p className="text-sm leading-relaxed text-mist-400">{feature.description}</p>
    </div>
  );
}
  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-mist-400">{group.blurb}</p>
      </div>
