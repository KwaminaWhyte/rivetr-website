...
export function CtaInstall() {
  ...
  return (
    <Section id="install">
      <Container>
        <div className="relative overflow-hidden rounded-2xl border border-ink-700 bg-ink-900 glow-ring">
          {/* Aurora glow */}
          <div
          ...
          <div className="relative z-10 px-8 py-16 text-center sm:px-16 sm:py-20">
            ...
            <div className="mx-auto mt-10 flex max-w-xl items-center justify-between gap-3 rounded-xl border border-ink-600 bg-ink-850 px-4 py-3">
              <div className="flex min-w-0 items-center gap-2">
                ...
                <code className="truncate font-mono text-sm text-mist-200">
                  {SITE.installCmd}
                </code>
              </div>
              ...
              <button
                ...
                className="shrink-0 rounded-md p-1.5 text-mist-400 transition-colors hover:bg-ink-700 hover:text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-400/60"
              >
                {copied ? (
